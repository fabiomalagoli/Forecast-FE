...
export class RequestsService {
    ...
    return this.fetchProgetti(`${environment.apiUrl}/projects`, 'Qualcosa è andato storto. Riprova più tardi.')
        .pipe(tap({
    ...
    aggiungiNuovoProgetto(progetto: Progetto) {
        ...
        return this.httpClient.put(`${environment.apiUrl}/projects/{` + progetto.id + '}', {
